...
<table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#000000" >
  <tr>
    <td width="100%" align="right"><img border="0" width="89" height="15"></td>
  </tr>
  </Table>
  <Table width="100%">
  <tr>
  ...
  ?>
	...
	{
	 echo "<div style=font-weight:bold;font-size:150%; align=\"right\"><strong><a href=\"index.php\"> Home </a>|<a href=\"signout.php\">Signout</a></strong></div>";
	}
	else
	{
	 	echo "&nbsp;";
